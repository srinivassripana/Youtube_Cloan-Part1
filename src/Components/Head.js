...
const Head = () => {
  ...
  return (
    <div className='grid grid-cols-12 items-center p-2 bg-white shadow'>
      ...
      <div className='flex items-center justify-center col-span-8'>
        <div className='flex items-center justify-center border border-black rounded-3xl w-1/2'>
          {showSearchIcon && (
            <span className='p-1'>
              <img
                className='h-8'
          ...
          <input
            className='border-none p-1 outline-none flex-grow m-2'
            type='text'
            placeholder='Search'
            onFocus={handleInputFocus}
            onBlur={handleInputBlur}
          />
          <button className='p-2 bg-gray-400 rounded-tr-3xl rounded-br-3xl'>
            <img
              className='h-8'
              alt='Search icon'
              src='https://endlessicons.com/wp-content/uploads/2015/08/search-icon-2-614x460.png'
        ...
        <img
          className='h-10 w-10 ml-2 rounded-full border border-gray-200 bg-gray-400 p-1 hover:cursor-pointer'
          alt='Voice icon'
      ...
      <div className='flex justify-center items-center col-span-2'>
        <img
          className='h-7 mx-4 hover:cursor-pointer'
          alt='Create icon'
          src='https://static.thenounproject.com/png/3750242-200.png'
        />
        <img
          className='h-6 mx-4 hover:cursor-pointer'
          alt='Notification icon'
          src='https://cdn-icons-png.flaticon.com/512/565/565422.png'
        />
        <img
          className='h-10 w-10 ml-4 rounded-full border border-gray-200 bg-gray-400 p-1 hover:cursor-pointer'
          alt='User icon'
